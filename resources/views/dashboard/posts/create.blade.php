    ...
    <div class="row">
        <section class="d-flex flex-column col-8">
            ...
            <div class="form-floating mt-3">
                <textarea id="content" name="content" class="form-control @error('content') is-invalid @enderror " placeholder="Write blogpost here" style="min-height: 50vh;">{{ old('content') }}</textarea>
        ...
        <aside class="border rounded-1 p-4 col-4">
            ...
            <div class="mb-3">
                ...
                <select id="category" name="category_id" class="form-select @error('category_id') is-invalid @enderror" data-old-value="{{ old('category_id') }}" aria-label="Select Category">
                    <option value="">---</option>
                </select>
                @error('category_id')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="readTime" name="read_time_minutes" class="form-control @error('read_time_minutes') is-invalid @enderror" value="{{ old('read_time_minutes') }}">
...
@section('page-script')
    @vite('resources/js/pages/page-post-dashboard-create.js')
@endsection
